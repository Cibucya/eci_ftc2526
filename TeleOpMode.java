...
public class TeleOpMode extends LinearOpMode {
    ...
    private void initHardware() {
        ...
        servoPrelaunch.setDirection(Servo.Direction.FORWARD);
    ...
    /** For some reason forward/backward works in the opposite direction. Changing the sign doesnt help. */
    ...
    private void handleLauncherToggle() {
        if (gamepad1.a && timeSince(lastAPress) >= PRESS_DELAY_MS) {
            ...
            motorLaunch.setPower(isLauncherOn ? 0.3 : 0);
    ...
    private void handleShooting() {
        if (gamepad1.b && timeSince(lastBPress) >= PRESS_DELAY_MS) {
            ...
            if (ballsToLaunch > 0  && servoPrelaunch.getPosition() == SERVO_PRELAUNCH_INIT_POSITION) {
                shootBall();
            }
