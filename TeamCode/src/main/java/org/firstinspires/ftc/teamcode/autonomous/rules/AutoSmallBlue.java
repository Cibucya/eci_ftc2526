...
@Autonomous
public class AutoSmallBlue extends BaseAuto {
    @Override
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            bot.startTravel((int) Math.round(1.75 * Field.FIELD_BLOCK_SIDE_LENGTH_MM), 1);
            ...
            bot.startTravel((int) Math.round(Field.FIELD_BLOCK_SIDE_LENGTH_MM * 0.85), 1);
            waitUntilFinished(100);
