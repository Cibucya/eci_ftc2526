...
@Autonomous(name="A: Straight Large", group="Launch Zone Exits")
public class AutoA_StraightLarge extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Ready for Case A: Straight Large Zone");
        telemetry.update();
