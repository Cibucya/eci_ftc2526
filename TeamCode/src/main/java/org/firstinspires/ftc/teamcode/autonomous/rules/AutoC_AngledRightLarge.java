...
@Autonomous(name="C: Angled Right Large", group="Launch Zone Exits")
public class AutoC_AngledRightLarge extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Ready for Case C: Angled Right Large Zone");
        telemetry.update();
